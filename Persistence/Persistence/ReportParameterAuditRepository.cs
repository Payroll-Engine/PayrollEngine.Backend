...
{
    public ReportParameterAuditRepository(IDbContext context) :
        base(DbSchema.Tables.ReportParameterAudit, DbSchema.ReportParameterAuditColumn.ReportParameterId, context)
    {
    }
