...
public class WageTypeResultRepository() : ChildDomainRepository<WageTypeResult>(Tables.WageTypeResult,
    WageTypeResultColumn.PayrollResultId), IWageTypeResultRepository
{
