...
public class ReportSetRepository(ReportSetRepositorySettings settings, bool auditEnabled) : 
    ReportRepositoryBase<ReportSet>(settings.RegulationRepository,
        settings.ScriptRepository, settings.AuditRepository, auditEnabled), IReportSetRepository
{
