...
{
    public GlobalCaseChangeRepository(CaseChangeRepositorySettings settings) :
        base(DbSchema.Tables.GlobalCaseChange, DbSchema.GlobalCaseChangeColumn.TenantId, settings)
    {
    }
