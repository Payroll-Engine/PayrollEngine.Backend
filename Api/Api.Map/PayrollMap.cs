...
/// </summary>
public class PayrollMap : ApiMapBase<DomainObject.Payroll, ApiObject.Payroll>
{
    protected override void SetupDomainToApiMapper(IMapperConfigurationExpression configuration)
    {
        ...
        configuration.CreateMap<DomainObject.ClusterSet, ApiObject.ClusterSet>();
    }
    ...
    protected override void SetupApiToDomainMapper(IMapperConfigurationExpression configuration)
    {
        ...
        configuration.CreateMap<ApiObject.ClusterSet, DomainObject.ClusterSet>();
    }
}