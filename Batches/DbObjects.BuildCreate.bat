...
call SqlScripter --script-create --exclude-use-database --exclude-extended-properties -f ../DbScripts/CreateObjectsDbScript.sql
echo formatting script
call SqlFormatter ..\DbScripts\CreateObjectsDbScript.sql
