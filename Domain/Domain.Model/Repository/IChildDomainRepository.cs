    ...
    where T : IDomainObject
{
    ...
    Task<IEnumerable<T>> QueryAsync(int parentId, Query query = null);
    ...
    /// <param name="itemId">The domain object id</param>
    /// <returns>The id of the parent object</returns>
    Task<T> GetAsync(int parentId, int itemId);
    ...
    Task<T> CreateAsync(int parentId, T obj);
    ...
    Task<IEnumerable<T>> CreateAsync(int parentId, IEnumerable<T> items);
    ...
    /// <param name="parentId">The parent object id</param>
    /// <param name="items">The domain objects to add</param>
    System.Threading.Tasks.Task CreateBulkAsync(int parentId, IEnumerable<T> items);
    ...
    Task<T> UpdateAsync(int parentId, T item);
