    ...
    where T : CaseChange
{
    ...
    Task<IEnumerable<T>> QueryAsync(int tenantId, int parentId, Query query = null);
    ...
    Task<T> AddCaseChangeAsync(int tenantId, int payrollId, int parentId, T caseChange);
}