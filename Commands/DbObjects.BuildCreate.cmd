...
call SqlScripter --script-create --exclude-use-database --exclude-extended-properties -f ../Database/Current/CreateObjectsDbScript.sql
echo formatting script
call SqlFormatter ..\Database\Current\CreateObjectsDbScript.sql
